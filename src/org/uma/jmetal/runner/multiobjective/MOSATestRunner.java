...
public class MOSATestRunner extends AbstractAlgorithmRunner {

	public static void main(String[] args) {

		Problem<IntegerSolution> problem = new SchedulingProblem(3);
		...
		AcceptanceCriteria<IntegerSolution> criteria = new AcceptanceCriteria<IntegerSolution>(TransitionRule.ScalarLinear);
//		MutationOperator mutation = new IntegerPolynomialMutation(0.9, 0.2);
		...
		algorithm = new MOSABuilder<IntegerSolution>(problem, mutation)
				...
				.setExplorationLevel(0.90)
				.setAlpha(0.95)
				.setAcceptanceCriteria(criteria)
				.setVariant(MOSABuilder.MOSAVariant.TEST).build();
