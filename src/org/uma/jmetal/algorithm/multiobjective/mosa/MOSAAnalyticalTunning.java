 ...
 * based on Frausto-Solís, Juan, Héctor Sanvicente-Sánchez, and Froilin Imperial-Valenzuela.
...
public class MOSAAnalyticalTunning<S extends Solution<?>> extends MOSA<S> {
	...
	public double explorationLevel;
	...
	public MOSAAnalyticalTunning(Problem<S> problem, int populationSize, double alpha, double maxDeterioration,
