...
public class MOSAHybridNSGAII<S extends Solution<?>> extends AbstractSimulatedAnnealing<S, List<S>> {
	 ...
	 */
	public MOSAHybridNSGAII(Problem<S> problem, int populationSize, double initialTemperature, double finalTemperature,
	...
	public String getDescription() {
		// TODO Auto-generated method stub
		return "Hibryd between MOSA and NSGAII";
	}
