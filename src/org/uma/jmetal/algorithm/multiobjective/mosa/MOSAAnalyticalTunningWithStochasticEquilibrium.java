...
public class MOSAAnalyticalTunningWithStochasticEquilibrium<S extends Solution<?>> extends MOSA<S> {
	...
	public MOSAAnalyticalTunningWithStochasticEquilibrium(Problem<S> problem, int populationSize, double alpha, double maxDeterioration,
